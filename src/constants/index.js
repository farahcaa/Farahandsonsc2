...
export const projects = [
  {
    ...
    text:[
      {
    message: "The Belmont AWT plant uses ferrous sulfate (pickle liquor) for sludge conditioning, odor, and phosphorus control. Previously stored in the basement, the chemical caused corrosion and limited expansion. The old tanks needed replacement.", 
    },
  {message: " Citizens Energy Group and Wessler Engineering built a new chemical storage and feed facility, designed to handle the corrosive nature of pickle liquor. It features a high-performance coating system, with controls, electrical distribution, and HVAC systems in separate rooms to prevent corrosion. An observation area allows operators to monitor the process without entering the corrosive space. The system is fully integrated into SCADA for monitoring and control",
    },
  ...
  },
  {
    ...
    text: [
      {
        message:"The Belmont and Southport Wastewater Treatment Plants each have 12 sand filters used for tertiary treatment. This project represents the first phase of rehabilitating these filters. Several factors influence the constructability of this project. Option No. 2 proposes performing the RIO and 42-inch BFV replacements simultaneously during the winter permit period of 2023/2024, from December 1, 2023, to April 30, 2024."
      },
      {
        message:"The scope of work includes installing two variable frequency drives for the 500 HP Backwash Pumps at both Belmont and Southport. It also involves replacing twelve 20-inch butterfly valves with modulating electric actuators and twenty-four 42-inch butterfly valves with electric actuators at both plants. Additionally, three filter manual backup control panels will be installed at each plant. Belmont will also receive two ship&apos;s ladders."
      },
      {
        message:"The project includes pipe fittings and couplings to aid in constructability, junction boxes, conduit and wire for new valve actuators, and miscellaneous integration of new devices into the SCADA. Site restoration is also part of the scope."
      }
    ],
  },
];
