...
const Contact = () => {
  ...
  return (
    <div className="flex flex-col w-full items-center justify-center my-10 font-serif">
      <h1 className="flex justify-center font-serif font-semibold  threexl:text-7xl lg:text-5xl xs:text-3xl">
        Get in Touch
      </h1>
      ...
      >
        ...
        <textarea
          ...
          onChange={handleChange}
          placeholder="Message"
          className="border border-black bg-DarkBlue rounded-[4rem] xs:w-[80%] md:w-[60%] lg:w-[40%] threexl:w-[30%] h-72 text-xl p-5 mb-10 text-white"
        />
        <PopupMessage />
      </form>
    </div>
