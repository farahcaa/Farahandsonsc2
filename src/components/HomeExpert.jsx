...
const HomeExpert = () => {
  return (
    <div className="flex lg:flex-row md:flex-col xs:flex-col w-full ">
      <img src={HomeBuilding} className="lg:w-1/2 xs:w-full xs:mb-2 pr-2 " />
      <div className="bg-DarkBlue w-1/2 xs:w-full rounded-lg lg:aspect-auto md:aspect-square  pl-2 ">
        ...
        <Link
          className=" text-Orange xl:text-2xl threexl:text-4xl xs:pb-10 md:pb-0 underline text-xl pt-20 flex justify-center pr-30 hover:cursor-pointer"
          to={`/Services`}
        >
          Learn More-&gt;
        </Link>
